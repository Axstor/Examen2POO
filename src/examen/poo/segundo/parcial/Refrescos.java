...
public class Refrescos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Refrescos");

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/r.jpg"))); // NOI18N
    ...
    private void btnCorteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCorteActionPerformed
     ...
     float a;
        ...
        total=(precio*c);
            totp= (total*a);
            float pre=(total-totp);//Se restara el descuento del 15%
        if(edad<50 && edad>50){//Solo se realizara si el usuario es de mayor de 50 o menor del 50
        ...
        if(edad==50){//Solo se realizara si la edad es igual de 50
              txtArea.append("Nombre del cliente: "+nombre+"\nEdad del cliente: "+edad+"\nLa cantidad que ordeno es de: "+c+"\n");
             txtArea.append("Tendra un descuento del 15% "+pre+ "\n");
        }
        }
