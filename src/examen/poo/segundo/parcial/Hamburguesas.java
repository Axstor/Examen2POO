...
public class Hamburguesas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/h.jpg"))); // NOI18N
   ...
   int usu,tusu;
    ...
    private void btnCorteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCorteActionPerformed
     ...
     float a;
        ...
        total=(precio*c);
            totp= (total*a);
            float pre=(total+totp);//en este caso 5% se suma porque es un aumento del precio
            
        if(c>1){//Si es mayor de uno la cantidad se hara lo siguiente
        ...
        if(c==1){//si la cantidad es igual a 1 se realizara lo siguiente (un aumento al precio)
             txtArea.append("Nombre del cliente: "+nombre+"\nEdad del cliente: "+edad+"\nLa cantidad que ordeno es de: "+c+"\n");
             txtArea.append("Debera de pagar un 5% +"+pre+ "\n");
        }
        }
